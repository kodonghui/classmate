...
**[Windows 0.1.3 설치 ZIP 받기](https://github.com/kodonghui/classmate/releases/download/v0.1.3/Corthex-Classmate-0.1.3-windows-x64.zip)** · **[버전별 다운로드](https://github.com/kodonghui/classmate/releases)** · **[문제 제보](https://github.com/kodonghui/classmate/issues)**

> 현재 배포판: **0.1.3 · Windows x64 · Chrome · Claude Code**
>
...
1. **내 PC에 Claude Code 설치·로그인** → 아래 **Windows 0.1.3 ZIP** 설치 → Chrome에 확장을 추가합니다. 자세한 경로는 [설치하기](#3-classmate-설치하기)를 참고하세요.
...
1. 위의 **Windows 0.1.3 설치 ZIP 받기**를 누릅니다.
2. 파일 이름이 `Corthex-Classmate-0.1.3-windows-x64.zip`인지 확인합니다.
...
```text
%LOCALAPPDATA%\Programs\CorthexClassmate\0.1.3\app\extension
```
...
6. **Corthex Classmate**, 버전 **0.1.3**, 사용 스위치 켜짐을 확인합니다.
...
**0.1.3는 확장과 로컬 도우미가 함께 바뀝니다. Chrome 새로고침만으로 새 파일이 다운로드되지는 않습니다.**
...
3. 새 0.1.3 ZIP을 전체 압축 해제하고 **Install.cmd**를 실행합니다.
4. Chrome을 다시 시작하고 확장 관리에서 새로 설치된 **0.1.3의 app\extension**을 로드합니다.
...
3. 버전 **0.1.3**인지 확인합니다. 숫자 버전 뒤의 `+g…`는 해당 빌드의 소스 식별자입니다.
